...
class AccountMove(models.Model):
    ...
    def _process_moves_debit(self):
        ...
        for move in self:
            ...
            result_msg_new_endpoint = self._post_to_debit_api('http://vsdc.iswe.co.zm/sandbox/stock/saveStockItems',
            ...
            result_msg_stock = self._post_to_debit_api('http://vsdc.iswe.co.zm/sandbox/stockMaster/saveStockMaster', payload_stock,
